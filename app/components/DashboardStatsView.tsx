...
import { IndianRupee, AlertCircle, TrendingUp, TrendingDown, Scale, Shirt, RefreshCcw } from 'lucide-react';
...
export default function DashboardStatsView({ stats, filter }: Props) {
